...
namespace GoVilla.Infrastructure.Migrations
{
    ...
    [Migration("20240130190042_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoVilla.Domain.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("GoVilla.Domain.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("GoVilla.Domain.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("GoVilla.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("GoVilla.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoVilla.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("GoVilla.Domain.Shared.ValueObjects.Money", "CleaningFee", b1 =>
                        {
                    ...
                    b.OwnsOne("GoVilla.Domain.Shared.ValueObjects.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("GoVilla.Domain.Apartments.ValueObjects.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("GoVilla.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("GoVilla.Domain.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                    ...
                    b.HasOne("GoVilla.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.OwnsOne("GoVilla.Domain.Shared.ValueObjects.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("GoVilla.Domain.Shared.ValueObjects.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("GoVilla.Domain.Shared.ValueObjects.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("GoVilla.Domain.Bookings.ValueObjects.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("GoVilla.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("GoVilla.Domain.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
